 ...
 */
final class Version20190617142054 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE offer (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, owner_id INT NOT NULL, buyer_id INT DEFAULT NULL, title VARCHAR(25) NOT NULL, description LONGTEXT NOT NULL, price INT NOT NULL, with_transport TINYINT(1) NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, weight BIGINT NOT NULL, locations LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', keywords LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', type VARCHAR(255) NOT NULL, end_price BIGINT DEFAULT NULL, INDEX IDX_29D6873E12469DE2 (category_id), INDEX IDX_29D6873E7E3C61F9 (owner_id), INDEX IDX_29D6873E6C755722 (buyer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE photo (id INT AUTO_INCREMENT NOT NULL, offer_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, size INT NOT NULL, link VARCHAR(255) NOT NULL, upload_at DATETIME NOT NULL, INDEX IDX_14B7841853C674EE (offer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE transaction (id INT NOT NULL, buyer_id INT NOT NULL, seller_id INT NOT NULL, offer_id INT NOT NULL, status TINYINT(1) NOT NULL, star_date DATETIME NOT NULL, end_date DATETIME NOT NULL, total BIGINT NOT NULL, seller_key CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', buyer_key CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', UNIQUE INDEX UNIQ_723705D11EC6416A (seller_key), UNIQUE INDEX UNIQ_723705D13448F789 (buyer_key), INDEX IDX_723705D16C755722 (buyer_id), INDEX IDX_723705D18DE820D9 (seller_id), INDEX IDX_723705D153C674EE (offer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
