 ...
 */
final class Version20190615142843 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE auction_bid (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, category_id INT NOT NULL, title VARCHAR(25) NOT NULL, description LONGTEXT NOT NULL, keywords LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', end_price BIGINT DEFAULT NULL, price INT NOT NULL, with_transport TINYINT(1) NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, weight BIGINT NOT NULL, pictures LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', locations LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_401A9C437E3C61F9 (owner_id), INDEX IDX_401A9C4312469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE bulk_purchase_offer (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, category_id INT NOT NULL, title VARCHAR(25) NOT NULL, description LONGTEXT NOT NULL, keywords LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', price INT NOT NULL, with_transport TINYINT(1) NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, weight BIGINT NOT NULL, pictures LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', locations LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_9B7263147E3C61F9 (owner_id), INDEX IDX_9B72631412469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE purchase_offer (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, category_id INT NOT NULL, title VARCHAR(25) NOT NULL, description LONGTEXT NOT NULL, keywords LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', price INT NOT NULL, with_transport TINYINT(1) NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, weight BIGINT NOT NULL, pictures LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', locations LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_FD1D04147E3C61F9 (owner_id), INDEX IDX_FD1D041412469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sale_offer (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, buyer_id INT DEFAULT NULL, category_id INT NOT NULL, title VARCHAR(25) NOT NULL, description LONGTEXT NOT NULL, keywords LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', price INT NOT NULL, with_transport TINYINT(1) NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, weight BIGINT NOT NULL, pictures LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', locations LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_F90ADFBD7E3C61F9 (owner_id), INDEX IDX_F90ADFBD6C755722 (buyer_id), INDEX IDX_F90ADFBD12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE transaction (id INT NOT NULL, buyer_id INT NOT NULL, seller_id INT NOT NULL, status TINYINT(1) NOT NULL, star_date DATETIME NOT NULL, end_date DATETIME NOT NULL, total BIGINT NOT NULL, seller_key CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', buyer_key CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', offer_id INT NOT NULL, UNIQUE INDEX UNIQ_723705D11EC6416A (seller_key), UNIQUE INDEX UNIQ_723705D13448F789 (buyer_key), INDEX IDX_723705D16C755722 (buyer_id), INDEX IDX_723705D18DE820D9 (seller_id), INDEX IDX_723705D153C674EE (offer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE auction_bid ADD CONSTRAINT FK_401A9C437E3C61F9 FOREIGN KEY (owner_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE auction_bid ADD CONSTRAINT FK_401A9C4312469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
        ...
        $this->addSql('ALTER TABLE bulk_purchase_offer ADD CONSTRAINT FK_9B72631412469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
        ...
        $this->addSql('ALTER TABLE purchase_offer ADD CONSTRAINT FK_FD1D041412469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
        ...
        $this->addSql('ALTER TABLE sale_offer ADD CONSTRAINT FK_F90ADFBD12469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE auction_bid DROP FOREIGN KEY FK_401A9C4312469DE2');
        $this->addSql('ALTER TABLE bulk_purchase_offer DROP FOREIGN KEY FK_9B72631412469DE2');
        $this->addSql('ALTER TABLE purchase_offer DROP FOREIGN KEY FK_FD1D041412469DE2');
        $this->addSql('ALTER TABLE sale_offer DROP FOREIGN KEY FK_F90ADFBD12469DE2');
