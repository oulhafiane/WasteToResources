 ...
 */
final class Version20190614165541 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE auction_bid (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, category_id INT NOT NULL, title VARCHAR(25) NOT NULL, description LONGTEXT NOT NULL, keywords LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', end_price BIGINT DEFAULT NULL, price INT NOT NULL, with_transport TINYINT(1) NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, weight BIGINT NOT NULL, pictures LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', locations LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_401A9C437E3C61F9 (owner_id), INDEX IDX_401A9C4312469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE purchase_offer (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, category_id INT NOT NULL, title VARCHAR(25) NOT NULL, description LONGTEXT NOT NULL, keywords LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', price INT NOT NULL, with_transport TINYINT(1) NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, weight BIGINT NOT NULL, pictures LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', locations LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_FD1D04147E3C61F9 (owner_id), INDEX IDX_FD1D041412469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sale_offer (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, buyer_id INT DEFAULT NULL, category_id INT NOT NULL, title VARCHAR(25) NOT NULL, description LONGTEXT NOT NULL, keywords LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', price INT NOT NULL, with_transport TINYINT(1) NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, weight BIGINT NOT NULL, pictures LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', locations LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_F90ADFBD7E3C61F9 (owner_id), INDEX IDX_F90ADFBD6C755722 (buyer_id), INDEX IDX_F90ADFBD12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
