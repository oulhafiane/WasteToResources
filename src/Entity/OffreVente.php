...
{
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Collecteur", inversedBy="offreVentes")
     * @ORM\JoinColumn(nullable=false)
     */
    private $proprietaire;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\GrossisteRevendeur", inversedBy="offreVentes")
     * @ORM\JoinColumn(nullable=false)
     */
    private $acheteur;
