 ...
 */
final class Version20190703172226 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bulk_purchase ADD offer_id INT NOT NULL, ADD seller_id INT NOT NULL, ADD weight BIGINT NOT NULL, ADD price BIGINT NOT NULL, ADD date DATETIME NOT NULL, ADD accepted TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bulk_purchase DROP offer_id, DROP seller_id, DROP weight, DROP price, DROP date, DROP accepted');
    }
}
