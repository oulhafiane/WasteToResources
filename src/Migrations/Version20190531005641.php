 ...
 */
final class Version20190531005641 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE achat (id INT AUTO_INCREMENT NOT NULL, offre_id INT NOT NULL, acheteur_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', qte INT NOT NULL, date DATETIME NOT NULL, status TINYINT(1) NOT NULL, INDEX IDX_26A984564CC8505A (offre_id), INDEX IDX_26A9845696A7BB5F (acheteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE achat_gros (id INT AUTO_INCREMENT NOT NULL, offre_id INT NOT NULL, acheteur_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', qte INT NOT NULL, date DATETIME NOT NULL, status TINYINT(1) NOT NULL, INDEX IDX_669375A14CC8505A (offre_id), INDEX IDX_669375A196A7BB5F (acheteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE collecteur (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', prenom VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, adresse LONGTEXT NOT NULL, solde INT DEFAULT NULL, points_fidelite INT DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, telephone VARCHAR(20) DEFAULT NULL, date_abonnement DATETIME NOT NULL, active TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE enchere (id INT AUTO_INCREMENT NOT NULL, offre_enchere_id INT NOT NULL, grossiste_acheteur_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', prix INT NOT NULL, date DATETIME NOT NULL, INDEX IDX_38D1870FC55509DE (offre_enchere_id), INDEX IDX_38D1870FD2DE7F30 (grossiste_acheteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE grossiste_acheteur (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', prenom VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, adresse LONGTEXT NOT NULL, solde INT DEFAULT NULL, points_fidelite INT DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, telephone VARCHAR(20) DEFAULT NULL, date_abonnement DATETIME NOT NULL, active TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE grossiste_revendeur (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', prenom VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, adresse LONGTEXT NOT NULL, solde INT DEFAULT NULL, points_fidelite INT DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, telephone VARCHAR(20) DEFAULT NULL, date_abonnement DATETIME NOT NULL, active TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, text LONGTEXT DEFAULT NULL, date_envoi DATETIME NOT NULL, vu TINYINT(1) DEFAULT NULL, destinataire_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', expediteur_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_B6BD307FA4F84F6E (destinataire_id), INDEX IDX_B6BD307F10335F61 (expediteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE offre_achat (id INT AUTO_INCREMENT NOT NULL, proprietaire_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', produit_id INT NOT NULL, prix INT NOT NULL, avec_transport TINYINT(1) NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, qte INT NOT NULL, date_creation DATETIME NOT NULL, INDEX IDX_718363CD76C50E4A (proprietaire_id), INDEX IDX_718363CDF347EFB (produit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE offre_achat_gros (id INT AUTO_INCREMENT NOT NULL, proprietaire_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', produit_id INT NOT NULL, prix INT NOT NULL, avec_transport TINYINT(1) NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, qte INT NOT NULL, date_creation DATETIME NOT NULL, INDEX IDX_4BCD128476C50E4A (proprietaire_id), INDEX IDX_4BCD1284F347EFB (produit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE offre_enchere (id INT AUTO_INCREMENT NOT NULL, proprietaire_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', produit_id INT NOT NULL, prix_fin INT DEFAULT NULL, prix INT NOT NULL, avec_transport TINYINT(1) NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, qte INT NOT NULL, date_creation DATETIME NOT NULL, INDEX IDX_940AF42F76C50E4A (proprietaire_id), INDEX IDX_940AF42FF347EFB (produit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE offre_vente (id INT AUTO_INCREMENT NOT NULL, proprietaire_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', acheteur_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', produit_id INT NOT NULL, prix INT NOT NULL, avec_transport TINYINT(1) NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, qte INT NOT NULL, date_creation DATETIME NOT NULL, INDEX IDX_DFA0CDD776C50E4A (proprietaire_id), INDEX IDX_DFA0CDD796A7BB5F (acheteur_id), INDEX IDX_DFA0CDD7F347EFB (produit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reaction (id INT AUTO_INCREMENT NOT NULL, text LONGTEXT DEFAULT NULL, date DATETIME NOT NULL, destinataire_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', expediteur_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_A4D707F7A4F84F6E (destinataire_id), INDEX IDX_A4D707F710335F61 (expediteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE transaction (id INT AUTO_INCREMENT NOT NULL, status TINYINT(1) NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME DEFAULT NULL, acheteur_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', vendeur_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_723705D196A7BB5F (acheteur_id), INDEX IDX_723705D1858C065E (vendeur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
